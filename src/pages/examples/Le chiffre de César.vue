<template>
  <q-page class="pa-4 text-center">
    ...
    <h2>Cryptosystèmes et clés de chiffrement</h2>
    ...
    <!-- Activité-2: Reprendre la même fonction que pour la Q-1 mais en l'adaptant à l'exercice, pour une clé de CESAR(4) [déchiffrement] -->

    <!-- Activité-3A (Implémentation du chiffrement de César): Demander aide à DONNER pour faire correcteur de code pour fonction "cesar_encrypt(text, d)"
    + Afficher Indice-n si bouton-n est appuyé -->

    <!-- Activité 3B (Implémentation du déchiffrement de César): Demander aide à DONNER pour faire correcteur de code pour fonction "cesar_encrypt(text, d)" -->

    <!-- Activité 4 (Cryptanalyse): Reprendre la même fonction que pour la Q-1 mais en l'adaptant à l'exercice
